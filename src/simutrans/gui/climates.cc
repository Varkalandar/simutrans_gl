	...
	gui_frame_t( translator::translate("Climate Control") )
{
	...
	add_table( 2, 0 );
	{
		...
		for( int i = 0; i < 4; i++ ) {
			wind_dir.new_component<gui_scrolled_list_t::const_text_scrollitem_t>( translator::translate( wind_dir_text[i] ), (gui_theme_t::gui_color_text) );
	...
	add_table(2,0);
	{
		...
		tree.new_component<gui_scrolled_list_t::const_text_scrollitem_t>( translator::translate( "none" ), (gui_theme_t::gui_color_text) );
		tree.new_component<gui_scrolled_list_t::const_text_scrollitem_t>( translator::translate( "random" ), (gui_theme_t::gui_color_text) );
		tree.new_component<gui_scrolled_list_t::const_text_scrollitem_t>( translator::translate( "rainfall" ), (gui_theme_t::gui_color_text) );
