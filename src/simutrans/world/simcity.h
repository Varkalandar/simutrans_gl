...
private:
	...
	sparse_tpl<rgb888_t> pax_destinations_old;
	sparse_tpl<rgb888_t> pax_destinations_new;
...
private:
	 ...
	 */
	void merke_passagier_ziel(koord ziel, rgb888_t color);
...
public:
	...
	*/
	...
	const sparse_tpl<rgb888_t>* get_pax_destinations_old() const { return &pax_destinations_old; }

	/// @returns passenger destination statistics for the current month
	const sparse_tpl<rgb888_t>* get_pax_destinations_new() const { return &pax_destinations_new; }
